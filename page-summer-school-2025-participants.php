<?php /*
Template Name: Summer School Participants (2025)
Description: Displays Summer School 2025 participants filtered by focus_area=ss2025.
*/ ?>
<?php
get_header();
?>
<div class="page-title tw-w-full tw-block  tw-relative tw--mt-[200px] tw-pt-[200px]">
    <div class="tw-container tw-mx-auto tw-px-4 tw-h-min-[200px] tw-pb-[80px] tw-pt-12">
        ...
        <p class="tw-text-light tw-text-sm tw-text-white tw-pt-2 tw-pl-5">Participants of the Summer School 2025</p>
    </div>
