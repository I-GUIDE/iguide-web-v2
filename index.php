...
<div
    class="tw-container tw-flex tw-flex-col tw-gap-5 lg:tw-gap-10 tw-px-10 lg:tw-grid md:tw-grid-cols-2 md:tw-grid-row-[min-content_min-content] tw-pt-10">
    <div class="tw-w-full tw-flex tw-justify-center tw-drop-shadow-xl md:tw-row-start-1 md:tw-row-span-2">
        <div class="tw-text-center lg:tw-text-left tw-w-full">
            <h1 class="tw-text-3xl md:tw-text-6xl lg:tw-text-7xl xl:tw-text-8xl">
                <span class="tw-text-ig-brown lg:tw-hidden">We are </span><span
                    class="tw-text-ig-blue tw-font-black">I</span><span
                    class="tw-text-ig-brown tw-font-black">-</span><span
                    class="tw-text-ig-teal tw-font-black">G</span><span
                    class="tw-text-ig-olive tw-font-black">U</span><span
                    class="tw-text-ig-light-green tw-font-black">I</span><span
                    class="tw-text-ig-orange tw-font-black">D</span><span
                    class="tw-text-ig-mustard tw-font-black">E</span>
            </h1>
        </div>
    </div>
    <div class="md:tw-col-start-2 md:tw-row-start-1 md:tw-row-span-2">
        <p
            class="tw-text-md md:tw-text-lg lg:tw-text-2xl tw-font-light tw-tracking-wide tw-mt-1 tw-text-center lg:tw-text-left">
            <strong>Vision:</strong> <br class="tw-hidden md:tw-block lg:tw-hidden"> Drive digital discovery and
            innovation <br class="tw-hidden md:tw-block lg:tw-hidden"> by harnessing the geospatial data revolution
        </p>
        <p
            class="tw-text-md md:tw-text-lg lg:tw-text-2xl tw-font-light tw-tracking-wide tw-mt-1 tw-text-center lg:tw-text-left tw-pt-4">
            <strong>Mission:</strong> <br class="tw-hidden md:tw-block lg:tw-hidden"> Advance convergence and geospatial
            sciences<br class="tw-hidden md:tw-block lg:tw-hidden"> for holistic sustainability solutions
        </p>
    </div>
</div>
...
<div class="tw-container overflow-visible">
    <div class="tw-flex tw-flex-col md:tw-px-0 md:tw-flex-row md:tw-gap-5 lg:tw-gap-10 tw-justify-start">
        <div class="vw-screen tw-pr-5 md:tw-w-4/12 lg:tw-w-1/3 md:tw-mt-7 md:tw-pl-5 lg:tw-mt-10 lg:tw-pl-17">
            <div id="tabs-nav"
                class="tw-text-black tw-text-[50px] md:tw-text-[2.5em] lg:tw-text-[4.7em] tw-font-semibold tw-text-shadow tw-inline-block">
                <h1 class="tw-mb-3 md:tw-mb-3 lg:tw-mb-5">
                    <span id="map" class="sweep-to-right tw-cursor-pointer tw-text-black" link="#map-slide">Map.
                    </span><br>
                    <span id="connect" class="sweep-to-right tw-cursor-pointer tw-text-black"
                        link="#connect-slide">Connect.</span><br>
                    <span id="discover" class="sweep-to-right tw-cursor-pointer tw-text-black"
                        link="#discover-slide">Discover.</span>
                </h1>
            </div>
            <p class="tw-text-black tw-text-sm md:tw-text-base tw-font-light inline-block">
                <strong>I-GUIDE</strong> is empowering diverse communities to produce data-intensive solutions to
                society’s resilience and sustainability challenges.
            </p>
        </div>
    ...
    <section class="i-guide-section">
        <div class="images-container">
            <div class="image-wrap">
                <div class="image-box box-1">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Image_5.png"
                        alt="Access to High-Performance Computing system">
                ...
                <div class="image-box box-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Image_4.png"
                        alt="Access to Datasets on Cloud">
                    <p>Access to Datasets on Cloud</p>
                </div>
                <div class="image-box box-3">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Image_6.png"
                        alt="Simulation with Hydrological Model WRFHydro">
        ...
        <div class="text-container">
            <div class="text-wrap">
                ...
                <p class="tw-text-sm lg:tw-text-base tw-font-light tw-my-5 ">The I-GUIDE platform is designed to harness
                    the vast, diverse, and distributed geospatial data at different spatial and temporal scales and make
                    them broadly accessible and usable to convergence research and education enabled by cutting-edge
                    cyberGIS and cyberinfrastructure.</p>
...
<div class="news-section tw-container tw-w-full tw-px-10 tw-my-10 tw-pb-10">
    ...
    <div
        class="news-grid tw-grid md:tw-grid-cols-3 lg:tw-grid-cols-4 md:tw-grid-rows-[max-content_min-content] md:tw-grid-flow-row tw-gap-3 md:tw-gap-5 lg:tw-gap-7  tw-mt-5">
        <?php
        $news_args = array(
            'posts_per_page' => 8,
...
<div class="tw-collob-section tw-w-full tw-my-16 tw-px-10 tw-max-w-full">
    <div class="tw-container">
        ...
        <div
            class="tw-flex tw-gap-x-5 tw-gap-y-10 md:tw-gap-y-10 tw-align-center tw-items-center tw-justify-content tw-mx-auto tw-flex-wrap tw-py-10 tw-mt-5">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/uiuc.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/columbiauniv.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/inst7.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/fiu.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/michiganstate.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/inst9.png" alt=""
                class="tw-mx-auto h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/purdue.png" alt=""
                class="tw-mx-auto h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/inst10.png" alt=""
                class="tw-mx-auto h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/inst8.png" alt=""
                class="tw-mx-auto h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/minnesota.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/utahstate.png" alt=""
                class="tw-mx-auto tw-h-[10vh] md:tw-h-[80px] lg:tw-h-[12vh]">
        </div>
    </div>
</div>
