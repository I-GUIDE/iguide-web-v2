...
?>
    ...
    <div class="page-content tw-w-full tw-flex tw-relative tw-bg-white tw-mt-5 tw-mb-16">
        ...
        $eval_leader_query = new WP_Query($eval_leader_args);
        ?>

        <div class="row justify-content-center">

            <?php if ( $eval_leader_query->have_posts() ) :?>
                <?php  while ( $eval_leader_query->have_posts() ) : $eval_leader_query->the_post(); ?>
        ...
        $eval_member_query = new WP_Query($eval_member_args);
        ?>
        <div class="row  justify-content-center">

        <?php if ( $eval_member_query->have_posts() ) :?>
        <?php  while ( $eval_member_query->have_posts() ) : $eval_member_query->the_post(); ?>
