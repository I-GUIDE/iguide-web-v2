...
?>
    ...
    <div class="page-content tw-w-full tw-flex tw-relative tw-bg-white tw-mt-5 tw-mb-16">
        ...
        $convergence_leader_query = new WP_Query($convergence_leader_args);
        ?>

        <div class="row justify-content-center">

            <?php if ( $convergence_leader_query->have_posts() ) :?>
                <?php  while ( $convergence_leader_query->have_posts() ) : $convergence_leader_query->the_post(); ?>
        ...
        $convergence_member_query = new WP_Query($covergence_member_args);
        ?>
        <div class="row  justify-content-center">

        <?php if ( $convergence_member_query->have_posts() ) :?>
        <?php  while ( $convergence_member_query->have_posts() ) : $convergence_member_query->the_post(); ?>
